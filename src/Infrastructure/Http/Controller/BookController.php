...
class BookController extends AbstractController
{
    ...
    {
        $createBookRequest = CreateBookRequest::fromServerRequest($request);
        $this->authorService->exists($createBookRequest->getAuthors());
        $createdBookExists = $this->commandBus->send($createBookRequest->toCommand());
        $bookDto = $this->queryBus->send(RetrieveBook::fromString($createdBookExists));
