...
use App\Infrastructure\RepositoryImplementation\GenreSqlRepositoryImplementation;
...
return [
    ...
    GenreRepositoryInterface::class => \DI\autowire(GenreSqlRepositoryImplementation::class),
];